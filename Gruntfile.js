// Generated on 2020-10-20 using generator-mendix 2.2.5 :: git+https://github.com/mendix/generator-mendix.git
/*jshint -W069*/
/*global module*/
"use strict";
...
var WIDGET_XML = path.join(currentFolder, "/src/", name, "/", name + ".xml");
...
module.exports = function (grunt) {
    grunt.initConfig({
        ...
        copy: {
            ...
            mpks: {
                files: [
                    { dest: TEST_WIDGETS_FOLDER, cwd: "./dist/", src: [ name + ".mpk"], expand: true }
                ]
            }
        },
        clean: {
            build: [
                path.join(currentFolder, "dist", name, "/*")
            ]
        },
        csslint: {
            strict: {
